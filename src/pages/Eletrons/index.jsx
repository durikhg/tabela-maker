...
{elementoInfo && (
  <div className="info-elemento">
    ...
    <div className="info-coluna">
      <p><strong>Configuração eletrônica:</strong> {elementoInfo.configuracao ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Nível de energia:</strong> {elementoInfo.niveldeenergia ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Grupo:</strong> {elementoInfo.grupo ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Período:</strong> {elementoInfo.periodo ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Bloco:</strong> {elementoInfo.bloco ?? 'N/D'}</p>
    </div>
  </div>
)}
          ...
          <table className="tabela">
            <thead>
              <tr>
                ...
                {/* marca as colunas do 1 ate o 18*/}
                {[...Array(18)].map((_, i) => (
