...
{elementoInfo && (
  <div className="info-elemento">
    ...
    <div className="info-coluna">
      <p><strong>Estrutura cristalina:</strong> {elementoInfo.estrutura_cristalina ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Estrutura molecular:</strong> {elementoInfo.estrutura_molecular ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Raio calculado:</strong> {elementoInfo.raio_calculado ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Raio covalente:</strong> {elementoInfo.raio_covalente ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Raio Van der Waals:</strong> {elementoInfo.raio_van_der_waals ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Raio iônico:</strong> {elementoInfo.raio_ionico ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Número de coordenação:</strong> {elementoInfo.numero_coordenacao ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Empacotamento atômico:</strong> {elementoInfo.empacotamento_atomico ?? 'N/D'}</p>
    </div>
  </div>
)}
        <div>
