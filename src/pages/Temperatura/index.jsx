...
{elementoInfo && (
  <div className="info-elemento">
    ...
    <div className="info-coluna">
      <p><strong>Número atômico:</strong> {elementoInfo.numero}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Ponto de fusão °C:</strong> {elementoInfo.ponto_fusao_celsius ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Ponto de fusão °F:</strong> {elementoInfo.ponto_fusao_fahrenheit ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Ponto de fusão K:</strong> {elementoInfo.ponto_fusao_kelvin ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Ponto de ebulição °C:</strong> {elementoInfo.ponto_ebulicao_celsius ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Ponto de ebulição °F:</strong> {elementoInfo.ponto_ebulicao_fahrenheit ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Ponto de ebulição K:</strong> {elementoInfo.ponto_ebulicao_kelvin ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Calor específico:</strong> {elementoInfo.calor_especifico ?? 'N/D'} J/g·K</p>
    </div>
  </div>
)}
