  ...
  return (
    ...
    <div  className="info-elemento">
       <div className="info-coluna">
         ...
         <div className="info-coluna">
        <p><strong>Condutividade térmica:</strong> {elementoInfo.condutividade_termica ?? 'N/D'}</p>
        </div>
         <div className="info-coluna">
        <p><strong>Condutividade elétrica:</strong> {elementoInfo.condutividade_eletrica ?? 'N/D'}</p>
        </div>
         <div className="info-coluna">
        <p><strong>Resistividade elétrica:</strong> {elementoInfo.resistividade_eletrica ?? 'N/D'}</p>
        </div>
         <div className="info-coluna">
        <p><strong>Resistividade térmica:</strong> {elementoInfo.resistividade_termica ?? 'N/D'}</p>
        </div>
         <div className="info-coluna">
        <p><strong>Condutor:</strong> {elementoInfo.comportamento_condutor ?? 'N/D'}</p>
        </div>
         <div className="info-coluna">
        <p><strong>Supercondutor:</strong> {elementoInfo.comportamento_supercondutor ?? 'N/D'}</p>
        </div>
    </div>
    )}
        <div>
