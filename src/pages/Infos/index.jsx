    ...
    <>
      ...
      {elementoInfo && (
        <div className="info-elemento">
          ...
          <div className="info-coluna">
            <p><strong>Número atômico:</strong> {elementoInfo.numero ?? 'N/D'}</p>
          </div>
          <div className="info-coluna">
            <p><strong>Tipo:</strong> {elementoInfo.tipo ?? 'N/D'}</p>
          </div>
          <div className="info-coluna">
            <p><strong>Massa atômica:</strong> {elementoInfo.massa ?? 'N/D'}</p>
          </div>
          <div className="info-coluna">
            <p><strong>Estado:</strong> {elementoInfo.estado ?? 'N/D'}</p>
          </div>
          <div className="info-coluna">
            <p><strong>Cor:</strong> {elementoInfo.cor ?? 'N/D'}</p>
          </div>
          <div className="info-coluna">
            <p><strong>Descobridor:</strong> {elementoInfo.descobridor ?? 'N/D'} ({elementoInfo.descoberta ?? 'N/D'})</p>
          </div>
          <div className="info-coluna">
            <p><strong>Origem do nome:</strong> {elementoInfo.origem_nome ?? 'N/D'}</p>
          </div>
          <div className="info-coluna">
            <p><strong>Wikipedia:</strong> <a href={elementoInfo.wikipedia} target="_blank" rel="noreferrer">Link</a></p>
          </div>
        </div>
      )}
