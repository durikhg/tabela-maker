...
{elementoInfo && (
  <div className="info-elemento">
    ...
    <div className="info-coluna">
      <p><strong>Eletronegatividade:</strong> {elementoInfo.eletronegatividade ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Eletroafinidade:</strong> {elementoInfo.eletroafinidade ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Reatividade:</strong> {elementoInfo.reatividade ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Série eletroquímica:</strong> {elementoInfo.serie_eletroquimica ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Formação de compostos:</strong> {elementoInfo.formacao_compostos ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Estabilidade química:</strong> {elementoInfo.estabilidade_quimica ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Comportamento ácido-base:</strong> {elementoInfo.comportamento_acido_base ?? 'N/D'}</p>
    </div>
    <div className="info-coluna">
      <p><strong>Afinidade com gases:</strong> {elementoInfo.afinidade_gases ?? 'N/D'}</p>
    </div>
  </div>
)}
